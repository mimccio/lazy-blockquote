...
export const options = {
  ...
  ...setDefaults(DEFAULTS_LAZY_BLOCKQUOTE, {}),
};
...
export const initialValueBasicMarks: SlateDocument = [
  {
    children: [
      ...
      createParagraph("This is a strikethrough text.", options.strikethrough.type),
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            type: options.li.type,
            children: [{ type: options.p.type, children: [{ text: "Numbered list" }] }],
          },
        ],
      },
      {
